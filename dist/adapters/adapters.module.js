...
exports.AdaptersModule = AdaptersModule = __decorate([
    (0, common_1.Module)({
        providers: [github_adapter_1.GithubAdapter, slack_adapter_1.SlackAdapter, google_adapter_1.GoogleAdapter],
        exports: [github_adapter_1.GithubAdapter, slack_adapter_1.SlackAdapter, google_adapter_1.GoogleAdapter],
    })
], AdaptersModule);
